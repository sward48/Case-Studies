...
bbox <- c(
  lng1 = min(df_map2024$lon),
  lat1 = min(df_map2024$lat),
  lng2 = max(df_map2024$lon),
  lat2 = max(df_map2024$lat)
)
...
leaf <- leaflet(df_map2024, options = leafletOptions(preferCanvas = TRUE)) %>%
  ...
  setView(lng = mean(df_map2024$lon),
          lat = mean(df_map2024$lat)+0.015,
          zoom = 12)


leaf
htmlwidgets::saveWidget(leaf, "figures/hamden2024.html", selfcontained = TRUE)
mapshot2(leaf, file = "figures/hamden2024.png", delay = 2, zoom = 0.5, vheight = 600, vwidth = 600)
```
...
leaf <- leaflet(df_map2023, options = leafletOptions(preferCanvas = TRUE)) %>%
  ...
  setView(lng = mean(df_map2023$lon),
          lat = mean(df_map2023$lat)+0.015,
          zoom = 12)

leaf
htmlwidgets::saveWidget(leaf, "figures/hamden2023.html", selfcontained = TRUE)
mapshot2(leaf, file = "figures/hamden2023.png", delay = 2, zoom = 0.5, vheight = 600, vwidth = 600)
```
